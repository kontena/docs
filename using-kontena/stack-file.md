...
* **`volumes_from`** - Mount all the volumes from one or more Kontena Service(s) that are part of this same Kontena Stack. A list of service names. See [example](#using-volumesfrom).
