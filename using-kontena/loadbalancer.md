...
* **`SSL_CERTS`** - SSL certificates to be used. See more at [SSL Termination](loadbalancer.md#using-kontena-load-balancer-for-ssl-termination).
* **`KONTENA_LB_SSL_CIPHERS`** - By default Kontena Load Balancer is using [strong SSL cipher suite](https://github.com/kontena/kontena-loadbalancer/blob/master/lib/kontena/templates/haproxy/main.text.erb#L8). If you want to use a custom cipher suite, you can specify it here. E.g. `ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384`.
